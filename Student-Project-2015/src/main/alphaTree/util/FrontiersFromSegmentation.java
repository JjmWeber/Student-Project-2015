...
public class FrontiersFromSegmentation extends Algorithm {
	...
	public void launch() throws AlgorithmException {
		...
		// very nasty but quick debug ...
		//TODO : correct and do it betterly
		inputImage = inputImage.copyImage(true);
		int size = inputImage.size();
		for(int i=0;i<size;i++)
			inputImage.setPixelInt(i, inputImage.getPixelInt(i)+1);
		int[] regionSize = null;
		try {
