...
public class WaterPixel extends Algorithm {
	...
	public void launch() throws AlgorithmException {
		...
		for(int y=step/2;y<yDim;y+=step)
			...
			{
				cores.add(new Pixel(lab.getPixelXYBDouble(x, y, 0),lab.getPixelXYBDouble(x, y, 1),lab.getPixelXYBDouble(x, y, 2),x,y));
				superPixelsCounter++;
			}
		System.out.println("number of created seeds of superpixels : "+superPixelsCounter);



		//For each cell, we now search the minimum of gradient to move our markers there
